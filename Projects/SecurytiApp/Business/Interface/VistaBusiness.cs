...
namespace Business.Interface
{
    public class VistaBusiness : IVistaBusiness
    {
            ...
            public async Task<VistaDto> GetById(int id)
            {
                ...
                vistaDto.Name = vista.nombre;
                vistaDto.Description = vista.descripcion;
                vistaDto.route = vista.ruta;
                vistaDto.moduleName = vista.modulo_id;
            ...
            {
                vista.Id = entity.Id;
                vista.nombre = entity.Name;
                vista.descripcion = entity.Description;
                vista.ruta = entity.route;
                vista.modulo_id = entity.moduleName;
